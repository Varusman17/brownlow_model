...
test_2017_data <- filter(final_factor_data,Season == "2017")
test_2017_data <- within(test_2017_data,rm(Season))
saveRDS(test_2017_data, file=paste0(model_dir,"Testing//test_2017_data_",version_no,".RDS")) 

# Subset to 2014 to 2017 data
final_factor_data <- subset(final_factor_data,Season > 2013&Season < 2018)
